...
export class AuthRepository {
    ...
    async courier_register(payload: UserType & Courier): Promise<string> {
        ...
        try {
            const { email, password, name, surname, lastname, CURP, vehicle_type, license_plate, phone, sex, brand, model, color, description } = payload;
            ...
            await connection.query(
                ...
                [userRecord.uid, vehicle_type, license_plate, 'Out of service', null, null, null, brand, model, color, description]
            );
